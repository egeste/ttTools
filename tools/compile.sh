...
if [ $1 == 'test' ]; then
  cat ttTools.js ttTools.views.js ttTools.database.js ttTools.tags.js ttTools.tags.views.js ttTools.portability.js ttTools.portability.views.js
  echo 'ttTools.init();'
elif [ $1 == 'release' ]; then
  epoch=`date +%s`
  mkdir releases/$epoch
  cat ttTools.js ttTools.views.js ttTools.database.js ttTools.tags.js ttTools.tags.views.js ttTools.portability.js ttTools.portability.views.js > releases/$epoch/ttTools.js
